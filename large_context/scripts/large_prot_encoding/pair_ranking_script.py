...
hel_pol_rnr_assembled_fasta = '/home/thibaut/will/save_all_contacts_results/Keep_assembled_annotated_sequences_corr_clustered.fasta'
# Attentions scores path : should be "pol_hel_rnr_{i}_full_attention_weighted.pt" with i index in fasta file. 
attention_path = '/home/thibaut/will/pol_hel_rnr_assembled_full_att2_corr/'
# Path to save as pkl interaction scores 
pkl_save_path = '/home/thibaut/interactions/saved_interactions/test/'
# Proteins labels path (used for plot, to fix). 
labels_folder = '/home/thibaut/will/save_all_contacts_results/KEEP_80/'
# For versions
saving_id = '3'
# Saving folder single fragment heatmap 
single_heatmap_path = '/home/thibaut/'
...
def get_pairs_dataset(fasta, attention_path, labels_folder, plot_fragment_heatmap = False) : 
    ...
    plot_fragment_heatmap = True
    for i, tuples in enumerate(data_assembled) : 
        if os.path.exists(attention_path+f'pol_hel_rnr_{i}_full_attentions_weighted.pt') :  # Check for attention file
            try : 
                id = tuples[0]
                ...
                attention_block = torch.load(attention_path+f'pol_hel_rnr_{i}_full_attentions_weighted.pt',weights_only=True) # Load attention file
                ...
                if multiprocess : 
                    ...
                    labels_file = f'{labels_folder}{genome_id}.txt'  # Get labels for heatmap & labeled lists
